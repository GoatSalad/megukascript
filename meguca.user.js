...
function insertCuteIntoCSS() {
    ...
    css.innerHTML = ".super_roll { animation: pink_blinker 0.4s linear " + getIterations(0.4) + "; color: pink; } @keyframes pink_blinker { 50% { color: deeppink } }" +
        ...
        ".planeptune_wins { animation: planeptune_blinker 0.6s linear " + getIterations(0.4) + "; color: #fff; } @keyframes planeptune_blinker { 50% { color: mediumpurple} }"+
        ".lastation_wins { animation: lastation_blinker 0.6s linear " + getIterations(0.4) + "; color: #fff; } @keyframes lastation_blinker { 50% { color: #333} }"+
        ".lowee_wins { animation: lowee_blinker 0.4s linear " + getIterations(0.4) + "; color: #fff; } @keyframes lowee_blinker { 50% { color: #e6e6ff }}"+
        ".leanbox_wins { animation: leanbox_blinker 0.4s linear " + getIterations(0.4) + "; color: #fff; } @keyframes leanbox_blinker { 50% { color: #4dff4d} }"+
